...
- You are already on a pre-1.0 Sigra line and can run the [v1.0 upgrade guide](../../../guides/introduction/upgrading-to-v1.0.md) in a branch. Repo path: `guides/introduction/upgrading-to-v1.0.md`.
