...
((.run.event=="workflow_dispatch" and .run.head_branch=="main" and .run.path==".github/workflows/ci.yml" and .run.inputs.phase_244_final_main==true and .run.inputs.recapture_branch=="" and .run.inputs.force_fail_probe==false and .run.inputs.force_rot_probe==false) or (.run.event=="push" and .run.head_branch=="main")) and
