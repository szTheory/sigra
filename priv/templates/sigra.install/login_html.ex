defmodule <%= web_module %>.SessionHTML do
  ...
  `<.form>` registers `phx-submit` by default, which was swallowing the
  browser form submit during UAT. With no LiveView process on the page,
  the browser performs a real HTTP POST to `SessionController.create/2`.
