defmodule <%= web_module %>.SessionHTML do
  @moduledoc """
  Controller-mode login templates for non-LiveView installs.

  Generated by `mix sigra.install --no-live`. Provides the same dual-mode
  login form (magic link + password) as the LiveView version, but as a
  standard Phoenix HTML template.
  """
  use <%= web_module %>, :html
  ...
  def new(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      ...
      <%% # Magic link section %>
      <.form :let={f} for={@form} id="magic_link_form" action={~p"/users/log_in"} method="post">
