...
<% else %>
  # Under --no-organizations the /organizations route is not wired, so
  # the :no_active_org branch is unreachable (it is only produced by
  # org-related plugs which are also omitted under --no-organizations).
  # Stub it to root so the behaviour is fully covered and the host app
