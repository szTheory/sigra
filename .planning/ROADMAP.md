...
- [x] 210-02-PLAN.md — Folded 208-03 (GROUP-02): flip the 11 mg-* L2 rows to bare Tier-2 with rich per-group evidence; monotonic guard exits 0, whole fractal reads 2
...
- [x] 211-02-PLAN.md — GATE-02: pre-flight phx_new 1.8.7 pin; install-golden byte-diff green; admin-acceptance-smoke renders elevated styled admin on a fresh generated host (GATE-02)
- [x] 211-03-PLAN.md — Clean terminal `mix test` gate: NoopTest shard-race confirmed in isolation; 204 stale-contract tests re-confirmed green; failures map only to accepted known/env set (GATE-01/GATE-02 supporting)
