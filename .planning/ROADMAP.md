...
- [ ] 244-01-PLAN.md — Split API/JWT generator contracts and lock four-combination idempotent emission.
- [ ] 244-02-PLAN.md — Enforce owner-bound PAT revocation and server-side scope allowlists.
...
| 244. PAT and Advanced JWT Truth Repair | 0/6 | Not started | - |
