...
- [x] 204-02-PLAN.md — Clean `mix test`: delete stale Phase192 known-failure contract + reconcile Vaultr→Tasklane doc/test drift (D-08/D-09)

**Wave 2** *(blocked on Wave 1)*

- [x] 204-03-PLAN.md — `.vt-status-pill` contrast fix + same-commit canary/audit recapture + zero-drift idempotency + monotonic guard (D-01..D-05/D-11)
...
- [x] 204-05-PLAN.md — Tier-2 lock verification + adversarial milestone review (v1.41-MILESTONE-AUDIT.md) + close housekeeping (D-10/D-11/D-13)
