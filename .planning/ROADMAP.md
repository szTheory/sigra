...
- [x] 240.3-05-PLAN.md — Guard the copyable contract and emit receipt-last exact-SHA runtime evidence.

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 240.3-06-PLAN.md — Suppress callback Referer disclosure and prove the next `/app` request carries no Referer header.

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 240.3-07-PLAN.md — Bind the full proof to a clean exact SHA and regenerate receipt-last evidence.
...
- [x] 242-02-PLAN.md — Isolate continuation cleanup evidence and rerun the complete Crosswake security matrix.
