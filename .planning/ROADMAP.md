...
**Plans**: 5 plans
  ...
  - [x] 197-05-PLAN.md — PW-03: remove `continue-on-error`, re-gate gallery, record SEED-006 correction (wave 3)
...
**Wave 1**
  ...
  - [x] 198-01-PLAN.md — `mix ci` local PR-gate mirror + CONTRIBUTING docs + contract-lock test (DX-01; D-01..D-04)

**Wave 2** *(blocked on Wave 1 completion)*

  - [x] 198-02-PLAN.md — design-gallery hard re-gate (confirm-green) + required-name/contract/snapshot guards + todo hygiene (GATE-02; D-06/D-07)

**Wave 3** *(blocked on Wave 2 completion)*

  - [x] 198-03-PLAN.md — `198-ACCEPTANCE.md` measured before/after evidence + MAINTAINING pointer (GATE-01/GATE-02; D-05)
