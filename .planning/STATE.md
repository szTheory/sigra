...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-06-23 — Completed quick task 260623-j59: fixed session-invalidation crashes in password-change + account-deletion (sibling of nft; 3 real-path defects masked by mock tests — missing session_store_opts, Sigra.Config struct not Access-compatible, schedule_deletion missing token_query_fn); 225 ExUnit 0 failures + new real-store integration coverage, regression-proven (880fe5fe, 9a157a9f, 5a25f665)
