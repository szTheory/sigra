...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-06-24 — Completed quick task 260624-vin: wired check_account_active into the example :require_authenticated pipeline (loop-safe exempt-path guards) so deletion-scheduled personas auto-redirect to /users/reactivation; mirrored guards into installer template + golden fixture; fixed an incidental microsecond-vs-:utc_datetime crash in Sigra.Testing deletion fixtures; 228 ExUnit 0 failures, golden_diff green on phx_new 1.8.7 (08c947b9→1ea02781)
