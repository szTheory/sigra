...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-07-18 — Completed quick task 260718-pdd: persona switch dropdown now shows a short unique descriptor per option (`Name — <descriptor>`) via new `Personas.taglines/0`
