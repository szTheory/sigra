# Requirements Archive: v1.45 RELEASE-CURRENCY

**Archived:** 2026-07-11
**Status:** SHIPPED (`override_closeout`) — 9/11 satisfied. PUB-04 (retire), PUB-05 (adopter-resolution proof), PROOF-01 (currency trust bundle) DEFERRED: all blocked on the operator/interactive Hex `1.20.0` retire, deferred indefinitely (no adopters). Resume `/gsd-execute-phase 223` after the retire. Root cause of the phantom `1.20.0`: ADR 003.
...
| PUB-05 | Phase 223 | Deferred (blocked on PUB-04 retire) |
...
| PROOF-01 | Phase 223 | Deferred (blocked on PUB-04/05) |
