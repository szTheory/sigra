...
outcome: All REQ IDs satisfied or explicitly waived per phase artifacts; traceability table complete.
---

# Requirements — v1.3 Cleanup & Hardening (archived)
...
Traceability: each REQ maps to exactly one phase in the v1.3 roadmap table (see `v1.3-ROADMAP.md`).
...
- [36-INVENTORY.md](../phases/36-retroactive-nyquist-validation/36-INVENTORY.md) — directory × `*-VALIDATION.md` classification (VAL-01).
- [36-WAIVERS.md](../phases/36-retroactive-nyquist-validation/36-WAIVERS.md) — explicit waivers for draft-status historical phases (VAL-02b).
