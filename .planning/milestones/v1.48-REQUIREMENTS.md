# Requirements Archive: v1.48 B2C-ALPHA-READINESS

**Archived:** 2026-08-12
**Status:** SHIPPED

The live requirements file is intentionally removed at milestone close. `$gsd-new-milestone` creates a fresh milestone-scoped requirements contract.
