...
- [x] **HARD-02**: release-please auto-publish is verified to fire end-to-end when a release is cut on a green `ci-gate` — **or** to fail loudly (not silently) when blocked — with the recovery/manual-dispatch runbook documented.
