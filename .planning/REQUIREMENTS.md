...
- [ ] **UPGRADE-02**: Maintainer can run an automated consumer upgrade smoke from latest `0.3.x` posture to `1.0.0`-candidate source and fail the release on unexpected compile/install/runtime regressions.
