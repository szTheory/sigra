...
- [x] **ELEVATE-03**: The batched elevation lands as a reviewable PR where the operator signs off only on the residual judgment calls and the proposed gradient raises (a before/after render strip + narrowed options) — not an open-ended issue hunt.
