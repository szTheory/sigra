...
- [x] **OA-02**: **`docs/uat-ci-coverage.md`** (and, if applicable, a **GA-03** pointer note in `.planning/v1.4-GA-UAT.md` or evidence index) names the **OA-01** test module(s) and states what machine proof **now** covers vs what remains **human / live-provider** only.
