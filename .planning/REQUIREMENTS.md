...
- [ ] **B2B-01**: Org admin can require MFA for all members of an organization, blocking access for non-MFA-enrolled members until enrollment, with the policy change recorded as an atomic audit row.
