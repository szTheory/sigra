...
## Current Milestone: v1.43 STABILIZE

**Goal:** Prove the foundation is green and trustworthy, unblock adopters on the latest Phoenix, and clear accumulated real-bug / robustness / review debt — no new features, no UI redesign — so the next milestone can be a clean-base admin/operator UI cleanup & feedback pass.
