...
**Domain:** Elixir/Phoenix open-source authentication library
**Researched:** 2026-04-04
**Confidence:** HIGH (all versions verified against hex.pm as of research date)
...
defp deps do
  [
    ...
    # Optional integrations (marked optional so they don't force transitive deps)
...
**For database multi-adapter support:**
...
**For the hybrid lib+generator model:**
...
---
*Stack research for: Elixir/Phoenix open-source authentication library (Sigra)*
*Researched: 2026-04-04*
