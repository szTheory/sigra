...
- **Last materially updated for:** **v1.15** (**2026-04-24**) — phase **`78`** / **`AUD-14`** reconciles **AUD-04-035..042** and **047** to **`lib/sigra/account.ex`** / **`lib/sigra/api_token.ex`** (**`Multi` + `log_multi_safe`**) in **44** inventory + **09-VERIFICATION** C-1 rows.
- **Planning trace:** Phase 9 → Phase 61 (AUD-01) → Phase 62 (AUD-02) → Phase 66 (AUD-09) → Phase 67 (AUD-10) → Phase 73 (AUD-11) → Phase 77 (AUD-13) → Phase 78 (AUD-14).
