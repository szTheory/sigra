...
The selected 1.0 package line is governed by the [Sigra 1.0 contract](contract.html). If you are reading `main` before Hex shows `1.0.0`, use the latest published `0.3.x` package or a source checkout until the release PR lands.
