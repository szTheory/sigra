defmodule Sigra.Install.AppSessionsGeneratorTest do
  ...
  @app_sources [
    ...
    "app_sessions/app_login_html.ex",
    "app_sessions/app_login_approve.html.heex",
  ...
  describe "static profiles and ceremony facade" do
    ...
    test "emits direct password and MFA adapters only behind the password-login flag" do
      ...
      assert direct =~ "authenticate_user: &authenticate_direct_user/2"
      assert direct =~ "%{enabled: true} -> {:ok, user, %{mfa_required: true}}"
