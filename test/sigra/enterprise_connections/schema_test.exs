defmodule Sigra.EnterpriseConnections.SchemaTest do
  ...
  defmodule MyApp.Accounts.EnterpriseConnection do
    ...
    schema "enterprise_connections" do
      ...
      embeds_one :oidc_settings, MyApp.Accounts.EnterpriseConnectionOIDCSettings, on_replace: :update
    ...
    def changeset(connection, attrs) do
      ...
      |> cast_embed(:oidc_settings, required: true, with: &MyApp.Accounts.EnterpriseConnectionOIDCSettings.changeset/2)
    end
  end
