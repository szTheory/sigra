defmodule Example.Repo.Migrations.CreateOrganizationAuthPolicies do
  ...
  def change do
    ...
    create table(:organization_auth_policy_exemptions, Keyword.merge(@prefix_opts, primary_key: false)) do
      add(:id, :binary_id, primary_key: true)
    ...
    create(unique_index(:organization_auth_policy_exemptions, [:organization_id, :user_id], @prefix_opts))
  end
end
