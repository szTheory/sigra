defmodule Example.Accounts.UserPasskey do
  @moduledoc """
  Ecto schema for WebAuthn passkey credentials in the example app.

  Stores credential identifiers, encrypted public keys, authenticator
  metadata, and usage tracking for Sigra passkey ceremonies.
  """
  ...
  schema "user_passkeys" do
    ...
    field :public_key, Example.Accounts.Encrypted.Binary
