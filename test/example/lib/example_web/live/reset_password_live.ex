defmodule ExampleWeb.ResetPasswordLive do
  @moduledoc """
  ...
  def handle_event("validate", %{"user" => user_params}, socket) do
    changeset =
      socket.assigns.user
      |> Example.Accounts.change_user_password(user_params)
  ...
  def handle_event("reset", %{"user" => password_params}, socket) do
    case Example.Accounts.reset_user_password(socket.assigns.user, password_params) do
      {:ok, _user} ->
        {:noreply,
         socket
