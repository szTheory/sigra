defmodule SigraInstallGoldenTmp.Accounts.Emails do
  ...
  def deletion_finalized_email(email) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account and associated data have been permanently removed. If you'd like to use %{app_name} again in the future, you're welcome to create a new account.", app_name: "SigraInstallGoldenTmp")}
    </p>
    """
