defmodule SigraInstallGoldenTmp.Accounts.Emails do
  @moduledoc """
  ...
  def suspicious_login_email(user, details) do
    ...
    reset_url = "#{SigraInstallGoldenTmpWeb.Endpoint.url()}/users/reset-password"
  ...
  def mfa_enabled_email(user, _opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Two-factor authentication has been enabled on your %{app_name} account. Your account is now more secure.", app_name: "SigraInstallGoldenTmp")}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def mfa_disabled_email(user, _opts \\ []) do
    settings_url = "#{SigraInstallGoldenTmpWeb.Endpoint.url()}/users/settings"
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Two-factor authentication was disabled on your %{app_name} account. If this wasn't you, re-enable MFA and change your password.", app_name: "SigraInstallGoldenTmp")}
    </p>
  ...
  def backup_code_used_email(user, opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "A backup code was used to sign in to your %{app_name} account. You have %{remaining} of 8 backup codes remaining.", app_name: "SigraInstallGoldenTmp", remaining: remaining)}
    </p>
  ...
  def mfa_lockout_email(user, _opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "We detected multiple failed two-factor authentication attempts on your %{app_name} account. Verification has been temporarily locked for 15 minutes.", app_name: "SigraInstallGoldenTmp")}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def email_change_confirmation_email(_user, new_email, url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "You requested to change your %{app_name} account email to this address. Click the button below to confirm the change.", app_name: "SigraInstallGoldenTmp")}
    </p>
  ...
  def email_change_notification_email(user, new_email, cancel_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Someone requested to change your %{app_name} account email from this address to %{new_email}. If this was you, no action is needed -- confirm the change from your new email.", app_name: "SigraInstallGoldenTmp", new_email: escaped_new_email)}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #dc2626; font-weight: 600; line-height: 1.5; font-family: #{@font_family};">
    ...
    #{dgettext("sigra", "Someone requested to change your %{app_name} account email from this address to %{new_email}. If this was you, no action is needed -- confirm the change from your new email.", app_name: "SigraInstallGoldenTmp", new_email: new_email)}
  ...
  def email_changed_email(user) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account email has been changed to this address. If you did not make this change, secure your account immediately.", app_name: "SigraInstallGoldenTmp")}
    </p>
  ...
  def deletion_scheduled_email(user, scheduled_date, cancel_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account has been deactivated and is scheduled for permanent deletion on %{date}. All sessions have been signed out.", app_name: "SigraInstallGoldenTmp", date: formatted_date)}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def deletion_cancelled_email(user, login_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account deletion has been cancelled. Your account is active again. You can log in as usual.", app_name: "SigraInstallGoldenTmp")}
    </p>
  ...
  def deletion_finalized_email(email) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account deletion has been finalized according to the configured deletion strategy. If you'd like to use %{app_name} again in the future, you're welcome to create a new account.", app_name: "SigraInstallGoldenTmp")}
    </p>
    """
  ...
  def password_changed_email(user, details) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account password was changed.", app_name: "SigraInstallGoldenTmp")}
    </p>
    <div style="margin: 16px 0; padding: 16px; background-color: #f4f4f5; border-radius: 8px;">
      <p style="margin: 0 0 8px 0; font-size: 14px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
        <strong>#{dgettext("sigra", "IP address:")}</strong> #{ip}
  ...
  The subject line includes both the inviter display name and the
  organization name as a phishing-defense measure — legitimate invites
  name both parties so the invitee can verify provenance. Every
  user-controllable field interpolated into the HTML body is passed
  through `html_escape_string/1` to defend against stored XSS.
  """
