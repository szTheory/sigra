defmodule SigraInstallGoldenTmp.Accounts.EnterpriseConnectionOIDCSettings do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    field :encrypted_client_secret, SigraInstallGoldenTmp.Accounts.Encrypted.Binary
