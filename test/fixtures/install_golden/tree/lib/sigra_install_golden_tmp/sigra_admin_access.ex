defmodule SigraInstallGoldenTmp.SigraAdminAccess do
  @moduledoc """
  ...
  alias SigraInstallGoldenTmp.Accounts.User, as: User
  alias SigraInstallGoldenTmp.Accounts.PlatformAdminGrant
