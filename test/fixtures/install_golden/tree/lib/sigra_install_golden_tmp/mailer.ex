defmodule SigraInstallGoldenTmp.Mailer do
  @moduledoc """
  Swoosh mailer wrapper.

  This file is emitted by `mix sigra.install` only if the host application
  does not already define a `SigraInstallGoldenTmp.Mailer` module. If the host
  ...
  """
  use Swoosh.Mailer, otp_app: :sigra_install_golden_tmp
end
