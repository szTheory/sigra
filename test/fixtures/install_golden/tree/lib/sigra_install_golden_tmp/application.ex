defmodule SigraInstallGoldenTmp.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: SigraInstallGoldenTmp.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SigraInstallGoldenTmpWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
