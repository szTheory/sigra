defmodule SigraInstallGoldenTmpWeb.Admin.ImpersonationController do
  @moduledoc """
  ...
  acting session via `SigraInstallGoldenTmpWeb.UserAuth.begin_impersonation/4`,
  ...
  alias SigraInstallGoldenTmpWeb.AuthErrorHandler
  ...
  defp impersonation_config do
    %{Accounts.sigra_config() | scope_module: SigraInstallGoldenTmp.Accounts.Scope}
  end
