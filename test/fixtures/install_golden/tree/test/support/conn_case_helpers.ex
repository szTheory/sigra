defmodule SigraInstallGoldenTmpWeb.ConnCaseHelpers do
  @moduledoc """
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = SigraInstallGoldenTmp.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user, opts \\ []) do
    ...
    token = SigraInstallGoldenTmp.Accounts.generate_user_session_token(user, type: type)
